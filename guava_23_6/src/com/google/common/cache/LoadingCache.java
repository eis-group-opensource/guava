...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
  ...
  /**
   * Returns {@link LocalReloadingCache} for supporting Richfaces 4.3.x as of new
   *
   * @note this method should never be used in any EIS subsystems
   *
   * @return default - null, other way, returning {@link LocalReloadingCache} for updating concurent hashmap runtime
   * @since 23.6-jre-e1
   * @deprecated
   * This method should not be used in any EIS suite. Method purpose is to support Richfaces 4.3.x
   */
  @Deprecated
  default ConcurrentMap<K, V> asReloadingMap(){
    return  null;
  }
}
